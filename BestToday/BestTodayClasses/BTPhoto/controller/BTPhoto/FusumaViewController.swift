...
public var fusumaBaseTintColor   = UIColor.hex("#969696", alpha: 1.0)
public var fusumaTintColor       = UIColor.hex("#212121", alpha: 1.0)
...
public var fusumaCameraRollTitle = "选择照片"
