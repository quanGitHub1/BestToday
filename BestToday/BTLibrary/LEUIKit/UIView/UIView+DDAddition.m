...
- (void)rotation:(float)roration animation:(BOOL)animation
{
    float duration = animation ? 0.25 : 0;
    [UIView animateWithDuration:duration animations:^{
        CGAffineTransform transform = CGAffineTransformMakeRotation(roration);
